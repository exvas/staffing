...
frappe.ui.form.on('Staffing Cost', {
    ...
    default_cost_rate_per_hour: function(frm) {
       if(cur_frm.doc.default_cost_rate_per_hour > cur_frm.doc.default_billing_rate_per_hour){
    ...
    friday_working_costing_rate: function(frm) {
       if(cur_frm.doc.friday_working_costing_rate > cur_frm.doc.friday_working_billing_rate){
