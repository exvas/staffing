...
def execute(filters=None):
	...
	columns.append({"label": "Addition", "fieldname": "additions", "fieldtype": "Data", "width": "100"},)
	...
	for type in types:
		...
		if len(data) > 0:
			...
			data[len(data)-1]['fifteen_percent'] =round((total_amount - total_ded + additions) * 0.15,2)
			data[len(data)-1]['grand_total'] =round(((total_amount - total_ded + additions) * 0.15),2) + (total_amount - total_ded + additions)
